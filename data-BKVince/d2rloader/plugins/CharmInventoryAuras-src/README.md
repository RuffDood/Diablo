...
Ports the D2R 2.4 `Charm Aura Zone Transition Fix` to D2R 3.2.92777 as a
build-gated D2RLoader native plugin.

Version 1.5.0 is hybrid: the same DLL can be installed either globally in
...
scan, refresh, and safety-guard counters.
